...
public class SimpleFileResourceStorageProvider implements IResourceStorageProvider {
    ...
    private final Logger logger = LoggerFactory.getLogger(SimpleFileResourceStorageProvider.class);
    private final ActorSystem system;

    public SimpleFileResourceStorageProvider(ActorSystem system) {
        this.system = system;
